...
namespace Pair_Programming_Console_Game_Repo
{
    ...
    {
        public void RockyOutcropContinue()
        {
            Console.WriteLine("You guide your ship toward the rocky outcrop.\n " +
        ...
        public void WhirlpoolContinue()
        {
            Console.WriteLine("You guide your ship toward the Spanish Galleon hoping to plunder it.\n" +
        ...
        public void KrakenContinue()
        {
            Console.WriteLine("Suddenly the legendary beast, the Kraken, appears!\n" +
        ...
        public void JungleContinue()
        {
            Console.WriteLine("You and your crew decide to chop your way through the dense jungle.\n" +
        ...
        {
            Console.WriteLine("You and your crew let greed take over, and start to pry out every jewel that is on the skull.\n" +
        ...
        public void SnakeTreasureContinue()
        {
            Console.WriteLine("Seeing that that snake statue is coiled around a chest, you decide that there must be treasure beneath it.\n" +
        ...
        public void BeachDoorContinue()
        {
            Console.WriteLine("Opening up the door you see the beach in front of you.\n" +
        ...
        public void DuelSwordChoice()
        {
            Console.WriteLine("You choose you trusty sword for it has led you through many a battle!\n" +
        ...
        public void DuelDaggerChoice()
        {
            Console.WriteLine("You notice that the dimensions of the cave favor a short blade, and you pull your dagger.\n" +
